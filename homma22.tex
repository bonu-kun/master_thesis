...
\\また\textbf{内挿方法間での比較}にて，銀河種ごとの天体使用数を増加させることで内挿方法によらず予測精度が向上することが分かった．このことから，学習データとテストデータの解像度差が1/2倍から1/4倍ほどである2値銀河形態分類は，モデルの学習の上振れを期待せずとも，高精度の形態予測を期待できる分類問題であると思われる．
...
\section{5章全体の議論・結論}
・どの補間方法を用いるべきか
・解像度差1/6より，1/7の方が優れている件について（画像plotしてみる，ピクセル数の切り捨てが起こっているのはどちらか，ピクセル切り捨てと補間により機械にとって重要な形態的特徴が損失している？という仮説を立てて終了）
・使用枚数何枚までならば高精度を保てるのか（枚数増やせば平均値上昇し低下，しかしながら実用的な高精度予測が行える（と，accuracy0.9以上という数で定義している）1/4の解像度差までならばどの枚数でも構わない，今回の実験で使用不可と判断した1/5以下について言うならば，リニアが優れているんじゃないかなあ（モデルの改善や検証手法？によっては1/5以下でも精度向上するかもで，そういう使い方するならリニアがいいなぁ，って言う））
